		...
		<div class="flex items-center gap-2">
			...
			<Portal target="#app">
				{#if isResetModalOpen}
					...
					>
						<span slot="content">
							<p>This will reset the board to its original state.</p>
							<p>Are you sure?</p>
						</span>
					</Modal>
				{/if}
			...
			<div class="hidden border-l-2 border-slate-200 dark:border-zinc-700 pl-2">
				...
				<Portal target="#app">
					{#if isSettingsWindowOpen}
						<Modal on:clickoutside={() => (isSettingsWindowOpen = false)}>
							<div slot="content">
								...
								<div class="mt-6 space-y-3">
									<div class="flex items-center justify-between">
										...
										<select
											...
											name="theme"
											id="theme"
											class="bg-transparent border-2 border-slate-200 dark:border-zinc-700 rounded-lg focus-visible:border-teal-400 focus-visible:outline-none focus-visible:ring-0 transition-colors"
										>
											<option class="dark:text-zinc-800" value="light"
												>Light</option
											>
											<option class="dark:text-zinc-800" value="dark"
												>Dark</option
											>
										</select>
									</div>
									...
									<div class="flex items-center justify-between">
										...
										<select
											...
											class="bg-transparent border-2 border-slate-200 dark:border-zinc-700 rounded-lg focus-visible:border-teal-400 focus-visible:outline-none focus-visible:ring-0 transition-colors"
										>
											<option class="dark:text-zinc-800" value="easy"
												>Easy</option
											>
											<option class="dark:text-zinc-800" value="normal"
												>Normal</option
											>
											<option class="dark:text-zinc-800" value="hard"
												>Hard</option
											>
										</select>
									</div>
